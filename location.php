...
<head>
  ...
  <!-- ✅ สไตล์เฉพาะหน้านี้: ทำให้การ์ดแคบลง -->
  <style>
    /* การ์ดแคบลง + padding ลดลง */
    .card-narrow{
      max-width: 720px;     /* ปรับได้ 640 / 680 / 720 */
      padding: 14px;        /* จาก 16px -> 14px */
      border-radius: 14px;  /* ดูกะทัดรัดขึ้นเล็กน้อย */
      margin-left: auto;
      margin-right: auto;
    }
    /* หัวการ์ดเว้นระยะน้อยลงนิด */
    .card-narrow .card-head{
      margin-bottom: 8px;
    }

    /* ฟอร์มค้นหา: จำกัดความกว้างบนเดสก์ท็อป และเต็ม 100% บนมือถือ */
    .loc-search{
      display:flex; align-items:center; gap:8px; flex-wrap:nowrap;
    }
    .loc-search .input{
      width: 280px; max-width: 50vw;   /* เดสก์ท็อป: แคบลง */
    }
    @media (max-width: 720px){
      .card-narrow{ max-width: 96%; }  /* มือถือ: ชิดขอบเล็กน้อย */
      .loc-search{ flex-wrap: wrap; }
      .loc-search .input{ width: 100%; max-width: 100%; }
      .loc-search .btn{ width: 100%; }
    }
  </style>
</head>
...
<body>
  ...
  <div class="layout">
    ...
    <main class="content">
      ...
      <!-- ✅ เพิ่มคลาส card-narrow -->
      <section class="card card-narrow">
        <div class="card-head">
          <h3 class="h5">รายการ</h3>
          <div style="display:flex;gap:8px;align-items:center;flex-wrap:wrap;">
            <!-- ✅ ใส่คลาส loc-search เพื่อควบคุมความกว้างอินพุต -->
            <form method="get" action="location.php" class="loc-search">
        ...
        <div class="table-wrap">
          <table class="table">
            ...
            <tbody>
              <?php $i = 1; foreach ($rows as $r): $id = (int)$r['location_id']; ?>
                <tr>
                  <td><?= $i++ ?></td>
